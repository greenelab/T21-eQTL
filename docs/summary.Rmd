...
Rendered at commit `` `r git_rev` `` (the commit checked out when this
document was last knitted; `results/` is gitignored, so the outputs
themselves are not versioned). This document reads:
